---
title: "Convexity: convex sets, convex functions. Strong convexity. PL condition."
...
$$
It is interesting, that Gradient Descent algorithm has linear convergence under this condition (you do not even need convexity here). 
